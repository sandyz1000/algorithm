...
...a) If the element is greater than the root then make it root and call heapify for Mean Heap
...b) Else ignore it.
// The step 2 is O((n-k)*logk)

3) Finally, MinHeap has k largest elements and root of the MinHeap is the kth largest element.
