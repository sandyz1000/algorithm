...
def hillclimb_and_restart(init_function, move_operator, objective_function, max_evaluations):
    ...
    while num_evaluations < max_evaluations:
        ...
        evaluated, score, found = hillclimb(init_function, move_operator, objective_function,
...
def reversed_sections(tour):
    """generator to return all possible variations where the section between two cities
    are swapped"""
...
def main():
    ...
    coords = read_coords(open(coord_file))

    # coords = [(37.7768016, -122.4169151),(37.7860105, -122.4025377),(37.7821494, -122.4058960),
    # (37.7689269, -122.4029053),(37.7768800, -122.3911496),(37.7706628, -122.4040139),
    # (37.7870361, -122.4039444),(37.7507903, -122.3877184),(37.7914417, -122.3927229),
    # (37.8672841, -122.5010216)]
    ...
    # Execute hill_climb
    iterations, score, best = hillclimb_and_restart(init_function, move_operator,
